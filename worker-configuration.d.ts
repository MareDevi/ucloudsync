/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f4459fc7a0543efe56c0c3232c91d1a4)
...
declare namespace Cloudflare {
	...
	interface Env {
		DB: D1Database;
		SYNC_QUEUE: Queue;
		TICKTICK_CLIENT_ID: "gim3UtJEkFwX1a1z2A";
		TICKTICK_CLIENT_SECRET: ")7ppzucmYBL@2_****(02V*rLIU17KD4";
		TICKTICK_REDIRECT_URI: "https://ucloudsync.maredevi.fun/oauth/ticktick/callback";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TICKTICK_CLIENT_ID" | "TICKTICK_CLIENT_SECRET" | "TICKTICK_REDIRECT_URI">> {}
}
